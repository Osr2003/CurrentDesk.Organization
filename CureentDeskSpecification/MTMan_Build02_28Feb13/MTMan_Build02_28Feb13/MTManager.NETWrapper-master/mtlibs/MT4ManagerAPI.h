...
struct ConPluginParam
  {
   ...
   PluginCfg*        params;                       // plugin parameters
...
struct MailBox
  {
   ...
   char*             body;                   // pointer to mail body
   ...
   inline void Init(LPCSTR lib_path=NULL)
     {
      ...
      if(m_lib) 
         ::FreeLibrary(m_lib);
	  // miktek coercing this to compile for the shorthaul miktek7.20.12
      // miktek hardwired to get this work until I can fix the problem
      if((m_lib=::LoadLibrary(L"C:\\MT4Manager\\mtmanapi.dll"))!=NULL)
        {
