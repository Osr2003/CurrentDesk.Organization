...
{    
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            try
            {
                //Check Whether User is already Authenticataed
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            try
            {
                ...
                {
                    // if (LoginVerification.ValidateUser(model.UserName, model.Password, LoginAccountType.LiveAccount))
                    if (LoginVerification.ValidateUser(model.UserName, model.Password))
                    {
                        ...
                        {
                            ModelState.AddModelError("", "Some error ocurred!");
                        }
                    }
                    else
                    {
        ...
        /// <summary>
        /// This Action Will Bring Up Partners Login
        /// </summary>
        /// <param name="returnUrl"></param>
        /// <returns></returns>
        [AllowAnonymous]
        public ActionResult PartnerLogin(string returnUrl)
        {
            ViewBag.ReturnUrl = returnUrl;
            return View();
        }        
        ...
        /// <summary>
        /// On Submission from Partner Login This action will be executed
        /// </summary>
        /// <param name="model"></param>
        /// <param name="returnUrl"></param>
        /// <returns></returns>
        [HttpPost]
        [AllowAnonymous]
        public ActionResult PartnerLogin(LoginModel model, string returnUrl)
        {
            //if (ModelState.IsValid)
            //{                
            //    if (LoginVerification.ValidateUser(model.UserName, model.Password, LoginAccountType.PartnerAccount))
            //    {
            //        FormsAuthentication.SetAuthCookie(model.UserName, model.RememberMe);
            //        return RedirectToAction("PartnerIndex", "Profile");
            //    }
            //    else
            //    {
            //        ModelState.AddModelError("", "The user name or password provided is incorrect.");
        ...
        public ActionResult LogOff()
        {
            ...
            //var acctInfo = ((LoginInformation)(System.Web.HttpContext.Current.Application["UserInfo"])).LogAccountType;

            //if (acctInfo == LoginAccountType.LiveAccount)
            //{
            //    return RedirectToAction("Login", "Account", FormMethod.Get);
            //}
            //else if (acctInfo == LoginAccountType.PartnerAccount)
            //{
            //    return RedirectToAction("PartnerLogin", "Account", FormMethod.Get);
            //}
