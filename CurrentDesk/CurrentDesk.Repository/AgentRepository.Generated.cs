...
{   
	internal partial class AgentRepository
	{
		private IRepository<Agent> _repository {get;set;}
		public IRepository<Agent> Repository
		{
			get { return _repository; }
			set { _repository = value; }
		}
		
		public AgentRepository(IRepository<Agent> repository, IUnitOfWork unitOfWork)
    	{
