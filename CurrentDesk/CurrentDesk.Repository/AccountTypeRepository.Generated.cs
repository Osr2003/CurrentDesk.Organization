...
{   
	internal partial class AccountTypeRepository
	{
		private IRepository<AccountType> _repository {get;set;}
		public IRepository<AccountType> Repository
		{
			get { return _repository; }
			set { _repository = value; }
		}
		
		public AccountTypeRepository(IRepository<AccountType> repository, IUnitOfWork unitOfWork)
    	{
