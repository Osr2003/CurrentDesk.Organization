...
{   
	internal partial class OrganizationRepository
	{
		private IRepository<Organization> _repository {get;set;}
		...
		public OrganizationRepository(IRepository<Organization> repository, IUnitOfWork unitOfWork)
    	{
