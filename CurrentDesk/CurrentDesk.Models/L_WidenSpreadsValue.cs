...
public partial class L_WidenSpreadsValue
{
    ...
    public virtual int PK_WidenSpreadsID
    {
    ...
    public virtual string WidenSpreadsValue
    {
    ...
    private void FixupAssetManagers(object sender, NotifyCollectionChangedEventArgs e)
    {
        ...
        if (e.OldItems != null)
        {
            foreach (AssetManager item in e.OldItems)
            {
                ...
                if (ReferenceEquals(item.L_WidenSpreadsValue, this))
                {
                    item.L_WidenSpreadsValue = null;
                }
